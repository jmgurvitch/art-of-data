...
def num_sock_colors():
    ...
    with open("socks.csv", "r") as socks_csv:
        ...
        for row in data:
            ...
            else: #if we've seen the sock color before
            ...
            elif row["Color 2"] != row["Color 1"]: #if we've seen the sock color before and the sock does not have the same color 1 and color 2
